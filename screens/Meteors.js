...
componentDidMount(){
    ...
    getMeteors=()=>{
    axios.get("https://api.nasa.gov/neo/rest/v1/feed?start_date=2015-09-07&end_date=2015-09-08&api_key=19fXwwGRvsLYNGBOi4INdvAxKHj9fQ62WyiEs7lZ")
        .then(response=>{
...
renderItem =({item})=>{
    ...
    let meteor_arr = Object.keys(this.state.meteors).map(meteor_date=>{
       ...
       meteors.sort(function(a,b){return b.threat_score-a.threatScore});
